...
**Files changed:** 22 (+232 / -202 lines)
...
| [`plugin/system/src/commands/database/migrate.ts`](plugin/system/src/commands/database/migrate.ts) | +1 | -1 |
...
| [`plugin/system/src/commands/spec/generate-snapshot.ts`](plugin/system/src/commands/spec/generate-snapshot.ts) | +1 | -1 |
