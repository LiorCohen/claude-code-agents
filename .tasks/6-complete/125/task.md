...
completed: 2026-02-12 22:15 UTC
depends_on: []
blocks: []
---
...
- [x] All 14 vague "refer to project-settings" instances replaced with proper delegation contracts (12 skills: backend-scaffolding ×2, helm-scaffolding, config-scaffolding, contract-scaffolding, database-scaffolding, helm-standards, commit-standards, planning, local-env, change-creation, integration-testing, e2e-testing; plus component-discovery:206)
- [x] 4 other vague cross-references fixed (spec-solicitation:500, spec-solicitation:501, spec-decomposition:472, component-discovery:349)
- [x] typescript-standards split or reduced to ≤500 lines (currently 1,055)
- [x] workflow-state split or reduced to ≤500 lines (currently 764)
- [x] Remaining 8 oversized skills reduced to ≤500 lines each (spec-decomposition 639, e2e-testing 619, spec-writing 595, external-spec-integration 559, postgresql 555, frontend-standards 553, integration-testing 553, spec-solicitation 515)
- [x] Circular dependency between workflow-state and spec-solicitation resolved
- [x] Code block at typescript-standards:404 given `text` language specifier
- [x] Re-audit passes with 0 failing categories
